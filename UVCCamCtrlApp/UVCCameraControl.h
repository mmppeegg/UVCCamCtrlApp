...
@interface UVCCameraControl : NSObject {
	long dataBuffer;
	//IOUSBInterfaceInterface190 **interface; // failed on macOS 12
    IOUSBInterfaceInterface942 **interface; // failed on macOS 12
    //IOUSBInterfaceInterface300 **interface; // failed on macOS 12
}
